...
$items = @('docs','release.ps1','verify-release.ps1','verify-scripts.ps1','startup.ps1','uninstall.ps1','driver.ps1','open-fpv.ps1','launch-fpv.ps1','launch-fpv.cmd','README.md','ARCHITECTURE.md','ACCEPTANCE.md','SECURITY.md','RELEASE_CHECKLIST.md')
