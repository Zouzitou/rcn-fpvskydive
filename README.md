...
```powershell
irm https://raw.githubusercontent.com/Zouzitou/rcn-fpvskydive/v0.1.49/bootstrap.ps1 | iex
```
...
```powershell
irm https://raw.githubusercontent.com/Zouzitou/rcn-fpvskydive/v0.1.49/install-from-source.ps1 | iex
```
